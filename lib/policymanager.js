  ...
  var policyManager = function(policyFilename) {
    ...
    try {
      ...
      var updateEnrollmentStatus = function () {
        this.genericURI['http://webinos.org/subject/id/PZ-Owner'] = getOwnerId();
        this.genericURI['http://webinos.org/subject/id/known'] = PzpAPI.getInstance().getTrustedList('pzh');
        pmr.reloadPolicy(this.genericURI);
      }
